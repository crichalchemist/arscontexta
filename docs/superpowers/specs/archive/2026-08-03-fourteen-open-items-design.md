...
CLAUDE.md divergence 5, "Verification gaps in the loop itself" (numbering shifts as entries open and close — match on the title) states *"the two older plans in `docs/superpowers/plans/` show 0 of 93 steps
