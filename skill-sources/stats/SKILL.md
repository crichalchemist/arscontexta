...
1. **`ops/derivation-manifest.md`** — vocabulary mapping
   - Use `vocabulary.notes` for the notes folder name and semantic search collection name
...
--=={ stats }==--
  ...
  {vocabulary.topic_maps}:   [MOC_COUNT] (covering [COVERAGE]% of {vocabulary.note_plural})
  Topics:                    [TOPIC_COUNT]
...
- **[MOC_COUNT]** {vocabulary.topic_maps} covering [COVERAGE]% of {vocabulary.note_plural}
