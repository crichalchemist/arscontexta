...
**Discovery mechanism:** Semantic search across domains. The reflect phase uses a hybrid reranked query without collection filtering to find conceptually related notes across all domains.
