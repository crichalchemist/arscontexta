...
{if config.semantic_search}
- (preferred): `mcp__qmd__query` with searches = [{type: "vec", query: "[the {vocabulary.note}'s description text]"}], collections = ["{vocabulary.notes_collection}"], limit = 10, rerank = false
